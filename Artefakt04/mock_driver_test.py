...
def run_mock_integration_test():
    ...
    # Ścieżki dopasowane do Twojej struktury
    verification_file = os.path.join("Artefakt04", "xpath_verification.txt")
    log_file = os.path.join("Artefakt04", "test_execution.log")
    ...
    if "STATUS: ZALICZONE" in content:
        ...
        print("=" * 40)
        print(f"Log zapisano do: {log_file}")
