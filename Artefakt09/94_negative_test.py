...
def test_api_errors():
    ...
    # Symulujemy wysłanie tekstu tam, gdzie serwer oczekuje określonej struktury
    ...
    # Większość publicznych API w takim przypadku powinna zwrócić 4xx
    ...
    if str(response_bad.status_code).startswith("4"):
        ...
        print(f"[INFO] API zwróciło kod: {response_bad.status_code}")
